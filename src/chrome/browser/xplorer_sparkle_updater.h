...
//
// Runtime-loads Sparkle.framework from the app bundle's Contents/Frameworks,
// instantiates SPUStandardUpdaterController (which checks for updates on its
// own schedule, shows Sparkle's native update dialog, downloads, installs, and
...
// if called more than once or if Sparkle.framework cannot be loaded.
